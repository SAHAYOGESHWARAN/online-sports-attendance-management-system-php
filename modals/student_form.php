      ...
      <input type="hidden" name="id" value="<?= $id ?? "" ?>">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                 <div class="mb-4">
                    <label for="class_id" class="form-label"> Name & Sport</label>
                    <select type="text" class="form-select" id="class_id" name="class_id" required="required">
                      <option value="" <?= !isset($id) ? "selected" : "" ?> disabled> -- Select sport Here -- </option>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="name" name="rollno" value="<?= $rollno ?? "" ?>" required="required">
                </div>
            </div>
        </div>
    </form>
